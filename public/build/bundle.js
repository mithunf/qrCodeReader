...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qrcodeReader = __webpack_require__(1);
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  qr.callback = function (result, err) {
	    if (result) {
	      ...
	      (0, _jquery2.default)('#imageContainer').append(result);
	    }
	    if (err) {
	      console.log("error : " + err);
	      (0, _jquery2.default)('#imageContainer').append(err);
	    }
	  };
	  ...
	  function check(file) {
	    ...
	    reader.onload = function (e) {
	      ...
	      (0, _jquery2.default)('#tempImage').attr("src", dataURL);
	      (0, _jquery2.default)('#tempImage').css("display", "none");
	      ...
	      img.onload = function () {
	        ...
	        (0, _jquery2.default)('#qr-canvas').css("display", "none");
	        qr.decode();
	      };
	    };
